...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'category', type: 'string', enum: ['hvac', 'electrical', 'plumbing', 'sound_system', 'general'], example: 'hvac'),
        new OA\Property(property: 'urgency', type: 'string', enum: ['low', 'medium', 'high', 'urgent'], example: 'high'),
        ...
        new OA\Property(
            ...
            example: ['uploads/maintenance/ac-photo.jpg'],
        ),
    ...
    #[OA\Get(
        ...
        description: 'Returns a paginated list of maintenance requests scoped to the authenticated mosque manager\'s mosque. Filterable by status.',
        security: [['bearerAuth' => []]],
        parameters: [
                ...
                content: new OA\JsonContent(
                    properties: [
                        ...
                        new OA\Property(
                            ...
                            type: 'array',
                            items: new OA\Items(
                                ref: '#/components/schemas/MaintenanceRequestItem',
                            ),
                        ),
                        new OA\Property(
                            property: 'pagination',
    ...
    #[OA\Post(
        ...
        description: 'Creates a maintenance request for the authenticated mosque manager\'s mosque. The `mosque_id` is resolved from the auth token — it is not accepted in the request body. Status is always set to `pending` on creation.',
        security: [['bearerAuth' => []]],
        parameters: [
            new OA\Parameter(ref: '#/components/parameters/AcceptLanguageHeader'),
        ],
                ...
                schema: new OA\Schema(
                    ...
                    properties: [
                        new OA\Property(
                            property: 'mosque_id',
                            type: 'integer',
                            description: 'ID of the mosque submitting the request.',
                            example: 7,
                        ),
                        new OA\Property(
                            property: 'title',
                        ...
                        new OA\Property(
                            ...
                            type: 'string',
                            maxLength: 5000,
                            example: 'The main hall AC has stopped cooling since yesterday.',
                        ),
                        new OA\Property(
                            property: 'category',
                            type: 'string',
    ...
    #[OA\Get(
        ...
        operationId: 'mosque.maintenanceRequests.track',
        tags: ['Maintenance Requests'],
        summary: 'Track a maintenance request by reference number',
        description: 'Retrieve a maintenance request and its full status history using its public reference number. Accessible to mosque managers (own mosque only) and super admins.',
        security: [['bearerAuth' => []]],
        parameters: [
            new OA\Parameter(ref: '#/components/parameters/AcceptLanguageHeader'),
            new OA\Parameter(
                ...
                in: 'path',
                required: true,
                description: 'Public reference number of the maintenance request (e.g. MR-XXXXXXXX).',
        ...
        responses: [
            new OA\Response(
                response: 200,
                description: 'Maintenance request tracking data retrieved successfully.',
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(property: 'status', type: 'string', example: 'success'),
                        new OA\Property(property: 'message', type: 'string', example: 'Maintenance request status retrieved successfully.'),
                        new OA\Property(
                            property: 'data',
                            type: 'object',
                            properties: [
                                new OA\Property(property: 'reference_number', type: 'string', example: 'MR-000123'),
                                new OA\Property(property: 'title', type: 'string', example: 'AC unit not cooling'),
                                new OA\Property(property: 'current_status', type: 'string', enum: ['pending', 'in_progress', 'completed', 'rejected'], example: 'in_progress'),
                                ...
                                new OA\Property(
                                    ...
                                    items: new OA\Items(
                                        ...
                                        properties: [
                                            new OA\Property(property: 'status', type: 'string', enum: ['pending', 'in_progress', 'completed', 'rejected'], example: 'pending'),
                                            new OA\Property(property: 'date', type: 'string', example: '21 May 2026, 10:30 AM'),
                                            new OA\Property(property: 'note', type: 'string', nullable: true, example: 'Request created'),
                                        ],
                                    ),
                                ),
                            ],
